...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_indented_dependency, 2),
  [167] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_indented_dependency, 2),
